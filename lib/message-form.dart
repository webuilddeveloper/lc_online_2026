...
ย้ายไปใช้ในโฟลเดอร์ lib/chat/ แล้วนะครับ เพื่อให้แยก role user/lawyer ได้ง่ายขึ้น
chat_bubble เป็น widget ที่ใช้แสดงข้อความในหน้า chat ทั้ง user และ lawyer
chat_input เป็น widget ที่ใช้แสดง input field และปุ่มส่งข้อความในหน้า chat ทั้ง user และ lawyer
ChatPageUser เป็นหน้าหลักของการแชทสำหรับ user
ChatPageLawyer เป็นหน้าหลักของการแชทสำหรับ lawyer
MessageFormPage ถูกเปลี่ยนเป็นใช้้ ChatPageUser และ ChatPageLawyer แทน
